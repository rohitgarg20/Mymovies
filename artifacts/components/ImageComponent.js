...
const imageComponent = (props) => {
    ...
    return (React.createElement(View, { style: styles.mainContainer },
        isError ? React.createElement(Image, { source: icons.ERROR_IMAGE, style: styles.image }) : React.createElement(Image, { source: {
                uri,
                cache: 'force-cache'
            }, style: styles.image, onLoadStart: onLoadStart, onLoadEnd: onLoadEnd, onError: onError, resizeMode: 'stretch' }),
        isLoading && (React.createElement(View, { style: styles.activityLoaderContainer },
            React.createElement(ActivityIndicator, { animating: true, size: 'small', color: 'lightBlue' })))));
};
export { imageComponent as ImageComponent };
